...
To deploy the infrastructure for this application please look at arm.json in Azure Infrastructure folder. Some of the paramters will need to be modified espeically the hostname basra.win and repository, if you want to deploy your own instance of this application. To deploy this ARM Template first create a new resourcegroup using the powershell Az Module: <code>New-AzResourceGroup $RG</code> and then deploy the ARM template with: <br>
